...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=YzQwNTc4NjJmN2FmMDAyZjM4NmZlZmNjYjNjYzk1MTJfNjg4MDY5NzI1YzM4MzIwYmViZmViZTY4NzI1ZTQ5M2NfSUQ6NzY1NzA4ODczMzA0NDY4OTg2MF8xNzgyODI2NTkzOjE3ODI5MTI5OTNfVjM)

cards\.js里用到了anime\.stagger这个函数，依赖第三方anime库。也就是说一定要先导入anime库，再导入cards\.js，这里代码层面的先后导入顺序需要程序员靠人脑记住。

![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=NmQ5MjgxYTc4YzY1YzYyNTViMjcyYmViZTIzODYxYjlfMjE0ZDY3NjFiZjZhNzkxOTA4ZmVhMjgxNGQ0ZTE5YjVfSUQ6NzY1NzA4OTExNTUzMTc1ODU3NV8xNzgyODI2NTkzOjE3ODI5MTI5OTNfVjM)

window是浏览器环境下的全局顶层对象，一个独立的html对应一个window。anime\.stagger是第三方库往当前页面的window挂的名字。容易想到引入的第三方库多的时候，不同的第三方库容易撞名字，导致全局污染。

![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ODAwMDc2OWRhYjNjNjI3NGNiYjFkOGJkMzExNDAyZjZfZDk0OGYzNjVkNGQ1NzMxNDU3NThkNzk3MjE4YWNkMTRfSUQ6NzY1NzA4OTI5Njg2NDg1NzAzNV8xNzgyODI2NTkzOjE3ODI5MTI5OTNfVjM)
